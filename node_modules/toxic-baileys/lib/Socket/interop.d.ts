...
export declare const makeInteropSocket: (config: SocketConfig) => {
    fetchIntegrators: () => Promise<{
        id: number;
        name: string;
        status: "active" | "onboarding" | "removed";
        icon: string | undefined;
        identifierType: "email" | "pn" | "username";
        optedIn: boolean;
        features: {
            groupMessaging: boolean;
        };
    }[]>;
    acceptInteropTOS: () => Promise<void>;
    optInIntegrators: (integratorIds?: number[]) => Promise<void>;
    optOutIntegrators: (integratorIds?: number[]) => Promise<void>;
    resolveInteropUser: (externalId: string, integratorId: number) => Promise<{
        externalId: string;
        integratorId: number;
        error: {
            code: number;
    ...
    getReachabilitySettings: () => Promise<{
    ...
    setReachabilitySettings: (users: {
        externalId: string;
        integratorId: number;
    }[], enabled?: string) => Promise<void>;
    blockInteropUser: (jid: string) => Promise<void>;
    unblockInteropUser: (jid: string) => Promise<void>;
    reportInteropSpam: (jid: string, spamFlow?: string) => Promise<void>;
    trustInteropContact: (jid: string) => Promise<void>;
    initInterop: () => Promise<{
        id: number;
        name: string;
        status: "active" | "onboarding" | "removed";
    ...
    INTEGRATOR_BIRDYCHAT: number;
    INTEGRATOR_HAIKET: number;
    aiGroupMetadata: (jid: string) => Promise<import("..").GroupMetadata>;
    aiGroupCreate: (subject: string, participants?: string[], options?: Record<string, any>) => Promise<import("..").GroupMetadata>;
    aiGroupAddBot: (jid: string, botUser?: string) => Promise<{
        status: string;
        jid: string | undefined;
    }[]>;
    aiGroupLeave: (id: string) => Promise<void>;
    aiGroupParticipantsUpdate: (jid: string, participants: string[], action: string) => Promise<{
        status: string;
        jid: string | undefined;
    ...
    aiGroupSettingUpdate: (jid: string, setting: string) => Promise<void>;
    ...
    sendInteractive: (jid: string, text: string, options?: {
        title?: string;
        subtitle?: string;
        footer?: string;
        buttonName?: string;
        quoted?: import("..").WAMessage;
    }) => Promise<string>;
    inappsignup: (jid: string, text: string, options?: {
        title?: string;
        subtitle?: string;
        footer?: string;
        buttonName?: string;
    ...
    inapp_signup: (jid: string, text: string, options?: {
        title?: string;
        subtitle?: string;
        footer?: string;
        buttonName?: string;
    ...
    checkUsername: (username: string, includeSuggestions?: boolean, sessionId?: string) => Promise<import("./username").UsernameCheckResult>;
    checkUsernameMulti: (usernames: string[]) => Promise<unknown>;
    setUsername: (username: string, options?: import("./username").SetUsernameOptions) => Promise<unknown>;
    deleteUsername: () => Promise<unknown>;
    getMyUsername: () => Promise<string | null>;
    getUsernameRecommendations: (source?: import("./username").UsernameSource | null) => Promise<unknown>;
    setUsernamePin: (pin: string | null) => Promise<unknown>;
    findUserByUsername: (username: string, pin?: string) => Promise<{
        jid: string;
        contact: boolean;
    } | null>;
    fetchContactUsernames: (...jids: string[]) => Promise<import("..").USyncQueryResultList[]>;
    USERNAME_QUERY_IDS: {
        readonly CHECK: "26124072630599518";
        readonly CHECK_MULTI: "27134626522840286";
        readonly SET: "27108705368767936";
        readonly GET: "32618050064506055";
        readonly GET_RECOMMENDATIONS: "26077456248616957";
        readonly PIN_SET: "25529696019976770";
    };
    ...
    fetchAccountReachoutTimelock: () => Promise<import("..").ReachoutTimelockState>;
    fetchNewChatMessageCap: () => Promise<import("..").NewChatMessageCapInfo>;
};
