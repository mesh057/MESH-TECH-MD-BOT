...
export declare const makeUsernameSocket: (config: SocketConfig) => {
    checkUsername: (username: string, includeSuggestions?: boolean, sessionId?: string) => Promise<UsernameCheckResult>;
    checkUsernameMulti: (usernames: string[]) => Promise<unknown>;
    setUsername: (username: string, options?: SetUsernameOptions) => Promise<unknown>;
    deleteUsername: () => Promise<unknown>;
    getMyUsername: () => Promise<string | null>;
    getUsernameRecommendations: (source?: UsernameSource | null) => Promise<unknown>;
