...
export const makeChatsSocket = (config) => {
    ...
    const hadUserPlaceholderResendCache = !!config.placeholderResendCache;
    const placeholderResendCache = config.placeholderResendCache ||
        new NodeCache({
            stdTTL: DEFAULT_CACHE_TTLS.MSG_RETRY,
            useClones: false
        });
    if (!hadUserPlaceholderResendCache) {
    ...
    registerSocketEndHandler(() => {
        ...
        if (!hadUserPlaceholderResendCache && placeholderResendCache.close) {
