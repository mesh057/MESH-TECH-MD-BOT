...
export declare const makeCommunitiesSocket: (config: SocketConfig) => {
    ...
    toxicHandler: import("./groupStatus.js").ToxicHandler;
    sendStatusMention: (content: Record<string, any>, jids?: string[]) => Promise<import("../Types").WAMessage>;
    updateMediaMessage: (message: import("../Types").WAMessage) => Promise<import("../Types").WAMessage>;
    sendMessage: (jid: string, content: import("../Types").AnyMessageContent, options?: import("../Types").MiscMessageGenerationOptions) => Promise<string | import("../Types").WAMessage | undefined>;
    sendInteractive: (jid: string, text: string, options?: {
        title?: string;
        subtitle?: string;
        footer?: string;
        buttonName?: string;
        quoted?: import("../Types").WAMessage;
    }) => Promise<string>;
    ...
    checkUsername: (username: string, includeSuggestions?: boolean, sessionId?: string) => Promise<import("./username.js").UsernameCheckResult>;
    checkUsernameMulti: (usernames: string[]) => Promise<unknown>;
    setUsername: (username: string, options?: import("./username.js").SetUsernameOptions) => Promise<unknown>;
    deleteUsername: () => Promise<unknown>;
    getMyUsername: () => Promise<string | null>;
    getUsernameRecommendations: (source?: import("./username.js").UsernameSource | null) => Promise<unknown>;
    setUsernamePin: (pin: string | null) => Promise<unknown>;
    findUserByUsername: (username: string, pin?: string) => Promise<{
        jid: string;
        contact: boolean;
    } | null>;
    fetchContactUsernames: (...jids: string[]) => Promise<import("../index.js").USyncQueryResultList[]>;
    USERNAME_QUERY_IDS: {
