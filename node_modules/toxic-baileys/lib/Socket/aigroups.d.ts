import type { GroupMetadata, SocketConfig } from '../Types/index.js';
import { type BinaryNode } from '../WABinary/index.js';
export declare const makeAIGroupsSocket: (config: SocketConfig) => {
    aiGroupMetadata: (jid: string) => Promise<GroupMetadata>;
    aiGroupCreate: (subject: string, participants?: string[], options?: Record<string, any>) => Promise<GroupMetadata>;
...
export declare const extractAIGroupMetadata: (result: any) => GroupMetadata;
//# sourceMappingURL=aigroups.d.ts.map